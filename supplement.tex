...
In order to both unify these different notions of fractal dimension and to allow us to prove our complexity bounds, we make a technical assumption about the self-similarity of the data set.
