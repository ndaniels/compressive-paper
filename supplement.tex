...
This data structure allows for similarity search queries in time roughly linear (provided the fractal dimension of the database is low) in the metric entropy of the database.
...
E-value threshold.
We used a coarse E-value of 1000, along with the BLASTN arguments
\texttt{-task blastn-short -penalty -1}, in order to account for the short
query sequences.
