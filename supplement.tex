...
\begin{definition}
    ...
    \]
\end{definition}
Intuitively, this just means that when we double the radius of a sphere around a point, the number of points in the larger sphere is roughly the number of points in the smaller sphere multiplied by $2^d$, or when we scale the radius by a factor of $\sigma$, the multiplication is by $\sigma^d$.
