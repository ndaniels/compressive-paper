...
We \underline{meet this demand} by substantiall generalizing and formalizing compressive genomics: we demonstrate a general scheme for accelerating search in life science databases, proving time and space complexity bounds in terms of entropy by exploiting the typically low fractal dimension of the underlying database, and releasing three new practical software tools for practitioners to use.
