...
For example, \cite{Mackelprang:2011} reported that using BLASTX to map 246
...
In particular, \cite{Murphy:2000, Peterson:2009} considered reducing the
amino-acid alphabet to 17, 10, or even 4 letters.
More recently, \cite{Zhao:2012} and \cite{Huson:2013} applied a reduction to
a 4-letter alphabet, termed a ``pseudoDNA'' alphabet, in sequence alignment.

In this work, we extend the compression approach of \cite{Daniels:2013} using
a reversible alphabet reduction.
We use the alphabet reduction of \cite{Murphy:2000} to map the standard amino
