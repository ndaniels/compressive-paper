...
\begin{abstract}
    \begin{itemize}
        ...
        \item We have formalized a data structure that allows similarity search in time- and space-complexity asymptotically linear to entropy
...
sometimes different distance functions can be used for the clustering versus searche;
