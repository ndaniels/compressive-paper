...
\begin{figure}[tbp]
    ...
    \begin{subfigure}[b]{0.40\textwidth}
        ...
        \includegraphics[width=1\textwidth]{assets/4rhv_cosine}
    \end{subfigure}%
    \begin{subfigure}[b]{0.40\textwidth}
        \caption{Euclidean distance}
        \label{fig:fragbag_euclid}
        \includegraphics[width=1\textwidth]{assets/4rhv_euclid}
    \end{subfigure}
    \begin{subfigure}[b]{0.40\textwidth}
        \includegraphics[width=1\textwidth]{assets/1ake_cosine}
        %\caption{}
    \end{subfigure}%
    \begin{subfigure}[b]{0.40\textwidth}
        \includegraphics[width=1\textwidth]{assets/1ake_euclid}
        %\caption{}
    \end{subfigure}
    \begin{subfigure}[b]{0.40\textwidth}
        \includegraphics[width=1\textwidth]{assets/1bmf_cosine}
        %\caption{}
    \end{subfigure}%
    \begin{subfigure}[b]{0.40\textwidth}
        \includegraphics[width=1\textwidth]{assets/1bmf_euclid}
        %\caption{}
    \end{subfigure}
    \begin{subfigure}[b]{0.40\textwidth}
        \includegraphics[width=1\textwidth]{assets/1rbp_cosine}
        %\caption{}
    \end{subfigure}%
    \begin{subfigure}[b]{0.40\textwidth}
        \includegraphics[width=1\textwidth]{assets/1rbp_euclid}
        %\caption{}
    \end{subfigure}
...
Additionally, we removed the sorting-by-distance feature of Andrew Gallant's FragBag search function, which does not improve the all-matching results we were interested in here---it lowers $k$-nearest neighbor search memory requirements while decreasing the speed of $\rho$-nearest neighbor, the problem at hand.
...
The entire 2014 Oct 31 version of the Protein Data Bank was downloaded and the database was composed of fragment frequency vectors generated from all of the relevant PDB files using the 400-11.json fragment list, as described in \citep{budowski2010fragbag}.
