...
\begin{table}
    \centering
    \caption{Average sensitivity of Topaz compared to FragBag when using cosine distance for the trials described in Figure \ref{fig:fragbag_cosine}. This table averages the sensitivities for each choice of search radii $\{0, 0.02, \ldots, 0.98\}$. (NB: no analogous table is given for euclidean distance as the Triangle Inequality ensures perfect recall).}
    \label{tab:fragbag_cosine_sensitivity}
    \begin{tabular}{|c|cccc|}
        \hline
        \backslashbox{Cluster radii}{Query protein}  & 4rhv & 1ake & 1bmf & 1rbp \\
        \hline
        0.05  & 0.999986  & 0.999859     & 0.999213 & 0.999034  \\
        0.10  & 1  & 0.999874     & 0.999128 & 0.999931  \\
        0.20  & 1  & 0.999897     & 0.999335 & 0.999813  \\
        0.30  & 1  & 0.999957     & 0.999716 & 1  \\
        0.40  & 1  & 0.999978     & 0.999849 & 1  \\
        0.50  & 1  & 0.999993     & 0.999972 & 1  \\
        \hline
    \end{tabular}
\end{table}
