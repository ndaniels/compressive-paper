...
\hl{As intimated above}, not only is Ammolite a practical tool that can dramatically accelerate the workflow of medicinal chemists, but its results also demonstrate the scalability of entropy scaling methods as databases grow.
...
For the coarse search, however, we first project the space of small molecules onto a subspace by removing nodes and edges that do not participate in simple cycles.
