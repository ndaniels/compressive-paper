...
In particular, we determined the mean local fractal dimension of the PubChem to be 
...
\begin{table}
\caption{\textbf{Benchmarks of Ammolite vs. SMSD on databases of (a) 1 million molecules (b) 10 million molecules (c) All of PubChem (47 million molecules)}}


\begin{subtable}{1\textwidth}
\caption{\textbf{Ammolite benchmark on database of 1 million molecules}}
\label{ammo1m}
\begin{tabular}{ccccc}
\hline
...
\begin{subtable}{1\textwidth}
\caption{\textbf{Ammolite benchmark on database of 10 million molecules}}
\label{ammo10m}
\begin{tabular}{ccc}
\hline
...
\begin{subtable}{1\textwidth}
\caption{\textbf{Ammolite benchmark on entire PubChem database}}
\label{ammo47m}
\begin{tabular}{ccc}
\hline
PubChem ID & Ammolite (hours) & Speedup \\
...
\begin{table}
\caption{\textbf{(a) Running time and (b) accuracy of BLASTX, caBLASTX, RapSearch2, and Diamond}}
\begin{subtable}{1\textwidth}
\caption{\textbf{Running time}}
\label{mgspeed}
\begin{tabular}{ccccc}
\hline
...
\begin{subtable}{1\textwidth}
\caption{\textbf{Accuracy against BLASTX}}
\label{mgacc}
\begin{tabular}{ccccc}
\hline
dataset & BLASTX & caBLASTX & RapSearch2 & Diamond \\
...
entropy at appropriate cluster radii is approximately 10:1.
