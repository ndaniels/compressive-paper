...
(similar to Diamond) at significantly greater accuracy.
...
BLASTX is also used to align assemblies thought to be exons to a protein
...
pipelines.
With respect to future work, it may be possible to apply entropy-scaling data
